...
export class LandingComponent {
  ...
  features: Feature[] = [
    ...
    { icon: '📲', titleKey: 'FEATURES.ITEMS.QR_ATTENDANCE_TITLE',  textKey: 'FEATURES.ITEMS.QR_ATTENDANCE_TEXT',  category: 'academics' },
    ...
    { icon: '📖', titleKey: 'FEATURES.ITEMS.EDU_BOOKS_TITLE',      textKey: 'FEATURES.ITEMS.EDU_BOOKS_TEXT',      category: 'commerce' },
