...
export interface CompanySettings {
  ...
  /** Opt-in: a PER_SESSION charge raised while taking attendance is confirmed
   *  PAID immediately, instead of sitting PENDING for a manual click. */
  autoConfirmSessionPayments: boolean;
