...
/**
 * The report itself: KPIs, the pool bar and the client table.
 *
 * Was the whole of AppComponent until the detail sheet became its own route —
 * picking a client now navigates to /client/:id instead of opening a panel over
 * the top, so a tenant can be linked to, reloaded and reached with the back
 * button.
 */
@Component({
  ...
  imports: [
    ...
    KpiTileComponent, PoolBarComponent, ClientTableComponent,
  ],
  template: `
    <div class="wrap">
      <header>
...
export class ClientsPageComponent {
  ...
  /** Picking a client is a navigation now, not a panel. */
