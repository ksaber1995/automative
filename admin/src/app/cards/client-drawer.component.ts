 ...
 *
 * Full-screen rather than a 420px side drawer because this is a working surface,
 * not a summary — a 500-row card table and a mint form don't fit in a strip down
 * the side of the page. It covers the console's sidebar too, which is the point:
 * while a print run is being prepared this IS the screen.
 */
@Component({
