...
type PermissionResource =
  ...
  | 'master_courses' | 'events' | 'rooms' | 'sessions';
...
const ROLE_DEFAULTS: Record<string, UserPermissions> = {
  GLOBAL_ADMIN: {
    ...
    master_courses: FULL, events: FULL, rooms: FULL, sessions: FULL,
  },
  ADMIN: {
    dashboard: FULL, branches: FULL, courses: FULL, classes: FULL,
    students: FULL, enrollments: FULL, employees: FULL, revenues: FULL,
  ...
  BRANCH_ADMIN: {
    ...
    master_courses: READ_WRITE, events: FULL, rooms: FULL, sessions: FULL,
  },
  BRANCH_MANAGER: {
    dashboard: READ_ONLY, branches: READ_ONLY, courses: FULL, classes: FULL,
    students: FULL, enrollments: FULL, employees: FULL, revenues: FULL,
  ...
  ACADEMIC_MANAGER: {
    ...
    master_courses: FULL, events: FULL, rooms: READ_WRITE, sessions: READ_WRITE,
  },
  SALES_MANAGER: {
    ...
    master_courses: READ_ONLY, events: READ_ONLY, rooms: READ_ONLY, sessions: READ_ONLY,
  },
  ACCOUNTANT: {
    dashboard: READ_ONLY, branches: READ_ONLY, courses: READ_ONLY, classes: READ_ONLY,
